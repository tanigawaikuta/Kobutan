...
namespace Kobutan.Config
{
    /// <summary>
    /// こぶたんのコンフィグ
    /// </summary>
    [Serializable]
    public class KobutanConfig : SerializableXML
    {
        #region 各種情報
        ...
        public struct CSetting
        {
            ...
            public struct CDirectory
            {
                ...
                public string ProtocolSpecifiations;
            }
        }
        ...
        public override void ApplyDefault()
        {
            ...
            Setting.Directory.ProtocolSpecifiations = @".\ProtocolSpecifiations\";
        }
